...
from community.models import Post, Category, Tag, Follow
...
class PostService:
            ...
            if filters:
                ...
                if 'search' in filters:
                    ...
                    queryset = queryset.filter(
                        ...
                        models.Q(excerpt__icontains=search_term)
                    )
    ...
    def _notify_followers(self, post):
        ...
        try:
            ...
            # 获取用户的关注者
            user_content_type = ContentType.objects.get_for_model(post.user)
