# Generated by Django 4.2.20 on 2025-04-30 15:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "wechat_unionid",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="微信UnionID"
                    ),
                ),
                (
                    "qq_openid",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["phone", "is_used"], name="users_verif_phone_838597_idx"
                    ),
                    models.Index(
                        fields=["email", "is_used"], name="users_verif_email_301b48_idx"
                    ),
                    models.Index(
                        fields=["code", "purpose"], name="users_verif_code_3f4fe3_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "auto_save_interval",
                    models.IntegerField(default=60, verbose_name="自动保存间隔(秒)"),
                ),
                (
                    "offline_mode",
                    models.BooleanField(default=False, verbose_name="离线模式"),
                ),
                (
                    "handwriting_recognition_mode",
                    models.CharField(
                        default="realtime", max_length=20, verbose_name="手写识别模式"
                    ),
                ),
                (
                    "ai_assistant_enabled",
                    models.BooleanField(default=True, verbose_name="启用AI助手"),
                ),
                (
                    "ai_assistant_model",
                    models.CharField(
                        default="gpt-3.5-turbo", max_length=50, verbose_name="AI助手模型"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "social_links",
                    models.JSONField(blank=True, default=dict, verbose_name="社交链接"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="创建时间"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "username",
                    models.CharField(
                        blank=True, max_length=150, null=True, verbose_name="用户名"
                    ),
                ),
                ...
                (
                    "timestamp",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="尝试时间"
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="users_login_ip_addr_7c2b9b_idx",
                    ),
                    models.Index(
                        fields=["username", "timestamp"],
                        name="users_login_usernam_9b9158_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "os_version",
                    models.CharField(blank=True, max_length=50, verbose_name="操作系统版本"),
                ),
                (
                    "app_version",
                    models.CharField(blank=True, max_length=50, verbose_name="应用版本"),
                ),
                (
                    "push_token",
                    models.CharField(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["device_id"], name="users_userd_device__c17433_idx"
                    ),
                    models.Index(
                        fields=["push_token"], name="users_userd_push_to_e31daa_idx"
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "refresh_token",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="刷新令牌"
                    ),
                ),
                (
                    "expires_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="users_third_user_id_2107b5_idx",
                    ),
                    models.Index(
                        fields=["provider", "uid"],
                        name="users_third_provide_d8e660_idx",
                    ),
                ],
