...
const largeMemoryAllocator = new LargeMemoryAllocator();

module.exports = largeMemoryAllocator;
module.exports.default = largeMemoryAllocator;
module.exports.LargeMemoryAllocator = LargeMemoryAllocator;
