...
describe('reminderSlice offline projection', () => {
  ...
  it('should fallback unsyncedCount to 0 when sync fulfilled remaining is null', () => {
    const state = remindersReducer(undefined, {
      type: syncReminders.fulfilled.type,
      payload: {
        synced: 0,
  ...
  it('should fallback unsyncedCount to 0 when sync fulfilled remaining is not a number', () => {
    const state = remindersReducer(undefined, {
      type: syncReminders.fulfilled.type,
      payload: {
        synced: 1,
  ...
  it('should reset unsyncedCount to 0 when sync rejected remaining is null', () => {
    const state = remindersReducer(undefined, {
      type: syncReminders.rejected.type,
      payload: {
        message: 'sync failed null remaining',
        remaining: null,
      },
    });
  ...
  it('should reset unsyncedCount to 0 when sync rejected remaining is Infinity', () => {
    const state = remindersReducer(undefined, {
      type: syncReminders.rejected.type,
      payload: {
        message: 'sync failed infinite remaining',
        remaining: Number.POSITIVE_INFINITY,
      },
    });
